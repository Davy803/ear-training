...
export function Incorrect({correctAnswer}: IncorrectProps) {
    return (
        <div className="w-full flex flex-col items-center gap-4">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Incorrect Answer!</h2>
            <XIcon className="w-24 h-24 text-red-500 dark:text-red-300"/>
            <p className="text-lg text-gray-700 dark:text-gray-300">
                Oops! The correct note was <span
                className="font-bold text-green-500 dark:text-green-300">{correctAnswer.text}</span>.
            </p>
        </div>
    )
}
