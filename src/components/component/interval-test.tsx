...
export function IntervalTest() {
    ...
    const notes = Object.keys(IntervalMap) as Note[];

    return <TestFramework headline={"Identify the interval"} getOptions={() => sampleSize(notes, 4)
        .map(x => ({text: x, notes: IntervalMap[x]}))}/>;
}
